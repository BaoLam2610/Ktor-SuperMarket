package com.lambao.domain.exceptions
...
enum class ErrorCode(val message: String) {
    ...
    PHONE_EXISTS("This phone number address is already registered."),
    ACCOUNT_EXISTS("Phone number or password is wrong. Try again"),
